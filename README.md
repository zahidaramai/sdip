...
```bash
docker run --rm -v "$PWD:/work" ghcr.io/zahidaramai/sdip:1.2.0 \
...
as `1.2.0`, `1.2` and `latest`. **Pin the exact version**, or a digest, for anything whose
...
```bash
pip install git+https://github.com/zahidaramai/sdip@v1.2.0
```
